...
def main():
    ...
    if name.startswith("simulations"):
        ...
        file_origin = "/home/lys/Dropbox/PhD/DRAUPNIR/benchmark_randall_original_naming"
        ...
        codeml_working_dir = "/home/lys/Dropbox/PhD/DRAUPNIR/Benchmark_Results/PAML/CodeML/benchmark_randall_original_naming/{}".format(sequence_input_type)
        codeml_out_dir = "/home/lys/Dropbox/PhD/DRAUPNIR/Benchmark_Results/PAML/CodeML/benchmark_randall_original_naming/{}/PAML_ARS_codeml_{}.out".format(sequence_input_type,name)
        ...
        phylobayes_working_dir = "/home/lys/Dropbox/PhD/DRAUPNIR/Benchmark_Results/PhyloBayes/benchmark_randall_original_naming/{}".format(sequence_input_type)
        iqtree_out_dir = "/home/lys/Dropbox/PhD/DRAUPNIR/Benchmark_Results/IQTree/benchmark_randall_original_naming/{}".format(sequence_input_type)
        fastml_out_dir = "/home/lys/Dropbox/PhD/DRAUPNIR/Benchmark_Results/FastML/benchmark_randall_original_naming/{}".format(sequence_input_type)
        fastml_working_dir = file_origin
