...
Contains the scripts utilized to
 ...
 a) perform benchmarking (benchmark.py)
 b) parse the results (parse_benchmark_results.py, FastML_Parser.py, IQTree_Parser.py)
 c) build comparison tables (merge_tables.py)
